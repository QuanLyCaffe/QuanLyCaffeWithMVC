...
namespace QLTiecCuoi
{
    public partial class DichVu : Form
    {
        ...
        {
            dt = bllDichVu.docDanhSachDichVu();
        }
        ...
        {
            CommonFunction.dinhDangThaoTacLuoi(dgvDichVu, true);
            dinhDangHienThiNut(true);
        }

        private void DichVu_Load(object sender, System.EventArgs e)
        {
            docDuLieu();
            hienThiDuLieu();
            CommonFunction.dinhDangThaoTacLuoi(dgvDichVu, false);
        }

        private void btLuu_Click(object sender, System.EventArgs e)
        {
            bllDichVu.luuDanhSachDichVu(dt);
            CommonFunction.dinhDangThaoTacLuoi(dgvDichVu, false);
            dinhDangHienThiNut(false);
        }
